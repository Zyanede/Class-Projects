...
public class SwordStock {
	...
	//there most likely is a better way to do this, including using a pattern or something
	...
	public static void createButtons(){
		...
		//Makes all the slots
		//on creation, each one is invisible and disabled, and the stock is started at 0
		for(int i = 0; i < 20; i++){
	...
	//the setvisible and setEnabled are used to make it appear once the stock is above 0
...
public static void removeSword(int constant){
		...
		//the newSword= = null makes sure you cant keep placing swords once they run out
		if(stock[constant] == 0){
